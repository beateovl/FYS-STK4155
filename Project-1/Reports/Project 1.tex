...
For the Ordinary Least Squares (OLS) method we see exactly what we expected. In figure \ref{fig:ols_vs_degree} we see how each 
...
\begin{figure}[H]
    ...
    \caption{The figure shows how the coefficients blow up as the complexity increases.}
