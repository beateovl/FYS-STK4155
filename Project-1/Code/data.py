...
"Everything needed to create the dataset and preparing the input for the models. "

#Creates syntetic data based on the Runge function with added noise.
...
# Creates polynomial features and optionally includes bias (intercept) term.
...
# Splits data into training and test sets, scales features, and centers target variable.
